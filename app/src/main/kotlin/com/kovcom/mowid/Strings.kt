...
object Group : StringKey("Group") {
    object Created : StringKey("Created", Group) {

        val value: String
            get() = DynoDict.instance.get(this)
    }

    object Removed : StringKey("Removed", Group) {

        fun value(name: String): String {
            return DynoDict.instance.get(this, Parameter.StringParameter(name, key = "name"))
        }
    }

    object Unselected : StringKey("Unselected", Group) {

        val value: String
            get() = DynoDict.instance.get(this)
    }

    object Selected : StringKey("Selected", Group) {
